...
Public data contains valuable information, but without proper analytical treatment it becomes difficult to interpret and use for decision-making. The Spanish vehicle fleet is a clear example: millions of territorially distributed records that, without modeling and structured visualization, make it hard to identify meaningful patterns.

This project analyzes Spain’s vehicle fleet in **2024** with the objective of extracting strategic insights regarding territorial distribution, vehicle type composition, fleet aging, and level of electrification.
...
- Detection of territorial imbalances in the vehicle fleet.
- Evaluation of the real pace of transition toward sustainable mobility.
- Identification of structural aging within the Spanish fleet.
- Serving as a foundation for predictive analysis or public policy studies.

## Objectives

- Analyze the territorial distribution of the vehicle fleet by Autonomous Community.
- Evaluate the structural composition by vehicle type.
...
The data was obtained in `Excel` format from the official website of the Dirección General de Tráfico (DGT).  
It includes information on:

- Composition of the vehicle fleet in Spain
- Vehicle age
- Driver census
- Number of vehicles by Autonomous Community, province, and municipality
- Distribution of vehicles by environmental label categories
- Total vehicles and classification by type

## Visualizations

- **KPIs**: Total number of vehicles, total number of drivers, percentage of electrified vehicles, vehicles per capita, overall average vehicle age
- **Horizontal bar chart**: Total vehicles by Autonomous Community  
- **Vertical bar chart**: Average age by vehicle type  
- **Stacked horizontal bar chart**: Distribution by vehicle type  
...
- An average vehicle age above 15 years indicates a structurally aging fleet, with potential impact on emissions and road safety.
- Andalusia, Catalonia, and Madrid concentrate the highest absolute number of vehicles, highlighting territorial imbalances.

### Conclusion

The analysis reveals a slower-than-expected energy transition and a structurally aging fleet, posing significant challenges for sustainable mobility policies and fleet renewal strategies.
